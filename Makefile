...
BUILD_DIR_OPKG:=$(BASE_DIR)/build-packages
BINARIES_DIR_OPKG:=$(BASE_DIR)/bin-packages
...
dirs: $(DL_DIR) $(TOOLCHAIN_DIR) $(BUILD_DIR) $(STAGING_DIR) $(TARGET_DIR) \
	$(HOST_DIR) $(BR2_DEPENDS_DIR) $(BINARIES_DIR) $(STAMP_DIR) $(BUILD_DIR_OPKG) $(BINARIES_DIR_OPKG)
...
#
#############################################################
$(DL_DIR) $(TOOLCHAIN_DIR) $(BUILD_DIR) $(HOST_DIR) $(BINARIES_DIR) $(STAMP_DIR) $(BUILD_DIR_OPKG) $(BINARIES_DIR_OPKG):
	@mkdir -p $@
...
clean:
	rm -rf $(STAGING_DIR) $(TARGET_DIR) $(BINARIES_DIR) $(HOST_DIR) \
		...
		$(BUILD_DIR_OPKG) $(BINARIES_DIR_OPKG)
