...
E2FSPROGS_BUILD_OPKG = YES

E2FSPROGS_SECTION = admin
E2FSPROGS_PRIORITY = important
E2FSPROGS_MAINTAINER = Vladimir Ivakin vladimir_iva@pisem.net
E2FSPROGS_DESCRIPTION = Utilities for use with the ext2 filesystem
...
define E2FSPROGS_REMOVE_UNNEEDED
	rm -f $(addprefix $1/, $(E2FSPROGS_BINTARGETS_))
	rm -f $(addprefix $1/, $(E2FSPROGS_TXTTARGETS_))
endef

define E2FSPROGS_TARGET_REMOVE_UNNEEDED
    $(call E2FSPROGS_REMOVE_UNNEEDED,$(TARGET_DIR))
endef

define E2FSPROGS_OPKG_REMOVE_UNNEEDED
    $(call E2FSPROGS_REMOVE_UNNEEDED,$(BUILD_DIR_OPKG)/e2fsprogs-$(E2FSPROGS_VERSION))
endef

E2FSPROGS_POST_INSTALL_TARGET_HOOKS += E2FSPROGS_TARGET_REMOVE_UNNEEDED
E2FSPROGS_PRE_BUILD_OPKG_HOOKS += E2FSPROGS_OPKG_REMOVE_UNNEEDED

define E2FSPROGS_MKE2FS_SYMLINKS
	ln -sf mke2fs $1/usr/sbin/mkfs.ext2
	ln -sf mke2fs $1/usr/sbin/mkfs.ext3
	ln -sf mke2fs $1/usr/sbin/mkfs.ext4
	ln -sf mke2fs $1/usr/sbin/mkfs.ext4dev
endef

define E2FSPROGS_TARGET_MKE2FS_SYMLINKS
    $(call E2FSPROGS_MKE2FS_SYMLINKS,$(TARGET_DIR))
endef

define E2FSPROGS_OPKG_MKE2FS_SYMLINKS
    $(call E2FSPROGS_MKE2FS_SYMLINKS,$(BUILD_DIR_OPKG)/e2fsprogs-$(E2FSPROGS_VERSION))
endef

ifeq ($(BR2_PACKAGE_E2FSPROGS_MKE2FS),y)
E2FSPROGS_POST_INSTALL_TARGET_HOOKS += E2FSPROGS_TARGET_MKE2FS_SYMLINKS
E2FSPROGS_PRE_BUILD_OPKG_HOOKS += E2FSPROGS_OPKG_MKE2FS_SYMLINKS
endif

define E2FSPROGS_E2FSCK_SYMLINKS
	ln -sf e2fsck $1/usr/sbin/fsck.ext2
	ln -sf e2fsck $1/usr/sbin/fsck.ext3
	ln -sf e2fsck $1/usr/sbin/fsck.ext4
	ln -sf e2fsck $1/usr/sbin/fsck.ext4dev
endef

define E2FSPROGS_TARGET_E2FSCK_SYMLINKS
    $(call E2FSPROGS_E2FSCK_SYMLINKS,$(TARGET_DIR))
endef

define E2FSPROGS_OPKG_E2FSCK_SYMLINKS
    $(call E2FSPROGS_E2FSCK_SYMLINKS,$(BUILD_DIR_OPKG)/e2fsprogs-$(E2FSPROGS_VERSION))
endef

ifeq ($(BR2_PACKAGE_E2FSPROGS_E2FSCK),y)
E2FSPROGS_POST_INSTALL_TARGET_HOOKS += E2FSPROGS_TARGET_E2FSCK_SYMLINKS
E2FSPROGS_PRE_BUILD_OPKG_HOOKS += E2FSPROGS_OPKG_E2FSCK_SYMLINKS
endif
