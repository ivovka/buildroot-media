...
define XFONT_FONT_MISC_MISC_CP_OPKG_SCRIPTS
    mkdir -p $(BUILD_DIR_OPKG)/$(XFONT_FONT_MISC_MISC_BASE_NAME)/CONTROL
    cp $(TOPDIR)/package/x11r7/xfont_font-misc-misc/opkg-postinst $(BUILD_DIR_OPKG)/$(XFONT_FONT_MISC_MISC_BASE_NAME)/CONTROL/postinst
endef

XFONT_FONT_MISC_MISC_POST_CONFIGURE_HOOKS += XFONT_FONT_MISC_MISC_MAPFILES_PATH_FIX

XFONT_FONT_MISC_MISC_PRE_BUILD_OPKG_HOOKS += XFONT_FONT_MISC_MISC_CP_OPKG_SCRIPTS
