...
define XFONT_FONT_BITSTREAM_TYPE1_CP_OPKG_SCRIPTS
    mkdir -p $(BUILD_DIR_OPKG)/$(XFONT_FONT_BITSTREAM_TYPE1_BASE_NAME)/CONTROL
    cp $(TOPDIR)/package/x11r7/xfont_font-bitstream-type1/opkg-postinst $(BUILD_DIR_OPKG)/$(XFONT_FONT_BITSTREAM_TYPE1_BASE_NAME)/CONTROL/postinst
endef

XFONT_FONT_BITSTREAM_TYPE1_PRE_BUILD_OPKG_HOOKS += XFONT_FONT_BITSTREAM_TYPE1_RM_FONTS_DIR
XFONT_FONT_BITSTREAM_TYPE1_PRE_BUILD_OPKG_HOOKS += XFONT_FONT_BITSTREAM_TYPE1_CP_OPKG_SCRIPTS
