...
define HOST_M4_COPY_ICONV
    mkdir -p $(HOST_DIR)/usr/share/aclocal-1.11
    cp package/{codeset,intl,iconv,lib-link,lib-prefix,lib-ld}.m4 $(HOST_DIR)/usr/share/aclocal-1.11/
endef

HOST_M4_POST_INSTALL_HOOKS += HOST_M4_COPY_ICONV
