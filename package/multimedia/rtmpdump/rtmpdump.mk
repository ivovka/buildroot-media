...
define RTMPDUMP_BUILD_OPKG_CMDS
    mkdir -p $(BUILD_DIR_OPKG)/rtmpdump-$(RTMPDUMP_VERSION)
    $(TARGET_MAKE_ENV) $(MAKE) $(RTMPDUMP_MAKE_OPT) DESTDIR=$(BUILD_DIR_OPKG)/rtmpdump-$(RTMPDUMP_VERSION) install -C $(RTMPDUMP_SRCDIR)
endef
