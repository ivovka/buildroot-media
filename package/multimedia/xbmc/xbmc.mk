...
XBMC_DEPENDENCIES = boost python zlib bzip2 lzo pcre alsa-lib libass enca curl libssh rtmpdump dbus xlib_libX11 xlib_libXext dbus xlib_libXt xlib_libXtst xlib_libXmu xlib_libXrandr mesa3d glew fontconfig fribidi libpng tiff freetype jasper libmad libsamplerate libogg libvorbis libcdio libmodplug faad2 flac wavpack lame libmpeg2 libbluray sdl sdl_mixer sdl_image sqlite mysql samba avahi libmicrohttpd libvdpau imaging libplist ConsoleKit yajl libnfs tinyxml taglib
XBMC_AUTORECONF = YES
